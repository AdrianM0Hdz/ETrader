...
from src.sales_and_purchases.domain.seller.entities.product.product import Product
from src.sales_and_purchases.domain.seller.entities.product.values import (
    ProductId,
    Price,
)
from src.sales_and_purchases.domain.seller.entities.product.enums import Cuerrency

from src.sales_and_purchases.domain.seller.entities.purchase.purchase import Purchase
from src.sales_and_purchases.domain.seller.entities.purchase.values import (
    PurchaseId,
    Quantity,
)
from src.sales_and_purchases.domain.seller.entities.purchase.enums import PurchaseStatus
