...
from src.sales_and_purchases.domain.seller.entities.purchase.values import PurchaseId


class MarkPurchaseAsCanceled:
    ...
    def __call__(
        ...
        seller.mark_purchase_canceled(product_id, purchase_id)
